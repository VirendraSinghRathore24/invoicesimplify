        ...
        <div className='flex flex-col w-5/12 m-auto p-4 mt-10 shadow-lg border-2 p-5 bg-white gap-y-4 rounded-md'>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-evenly">
                    ...
                    <button type='button' onClick={() => navigate('/taxinfo')} className='px-2 py-2 rounded-md text-black w-3/12 border-[1.4px] border-black'>Cancel</button>
                          <button type='submit' className='bg-[#444] px-2 py-2 rounded-md text-white w-3/12'>Update</button>
                    </div>
                </div>
