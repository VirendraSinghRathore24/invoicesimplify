                ...
                <div className='relative'>
                    ...
                    {isMenuOpen && (
                        <div className='absolute right-0 mt-3 w-48 bg-white border border-gray-300 rounded-md shadow-lg'>
                            <div className='px-4 py-2 text-sm text-center text-gray-700 font-bold'>{userCode}</div>
                            <hr/>
                            <div className='px-4 py-2 text-sm text-center text-amber-800 font-bold'>Free</div>
                            <hr/>
                            <div
