...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 h-screen bg-[#014459] text-white flex flex-col shadow-lg">
      ...
      <div className="text-sm font-bold py-2 border-b border-white text-center">{loggedInUser}</div>
      ...
      <nav className="flex-1 px-4 py-2 overflow-y-auto">
        ...
        >
          ...
          <SubMenuItem text="Logout" to="/logout" active={location.pathname === '/logout'} />
...
const SidebarItem = ({ icon, text, hasSubMenu, isOpen, onClick, children, link, active }) => {
    const baseClasses = 'flex items-center space-x-3 px-3 py-3 rounded-md transition';
