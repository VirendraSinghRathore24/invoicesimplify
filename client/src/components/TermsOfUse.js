        ...
        <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 mt-24 mb-10">
          ...
          <section className="space-y-6 text-md leading-relaxed text-justify">
            ...
            <div>
              ...
              <p>
                InvoiceSimplify provides tools for creating, managing, and
                sending invoices. We reserve the right to modify or discontinue
            ...
            <div>
              ...
              <p>
                ...
                services at any time for violation of these terms or misuse of
                the platform.
              </p>
            </div>
