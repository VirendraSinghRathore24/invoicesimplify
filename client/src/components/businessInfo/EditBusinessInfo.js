...
function EditBusinessInfo() {
  ...
  return (
    <div className="flex justify-evenly w-full h-full">
      <div className="w-full lg:w-[82%] ml-0 lg:ml-[17%] border-2 my-3 rounded-lg border-gray-300 bg-white shadow-lg top-0 lg:fixed h-[96.7%]">
        ...
        <div className="flex flex-col bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
          <main className="flex-grow container mx-auto px-1 py-2">
            <div className="max-w-10xl mx-auto bg-white border-2 rounded-xl p-4">
