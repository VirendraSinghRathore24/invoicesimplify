...
const SellerInvoice = () => {
  ...
  const sellers = [
    ...
    {
      name: "Rathore General Store",
      address: "Plot 45 Industrial Area, Molasar",
      city: "Kuchaman City",
      state: "Rajasthan",
      pincode: "110001",
      gstin: "29ABCDE1234F2Z5",
  ...
  const items = [
    { id: 1, name: "Colgate", price: "100 g" },
    { id: 2, name: "Colgate", price: "200 g" },
    { id: 3, name: "Service X", price: 500 },
    { id: 3, name: "Service X", price: 500 },
    { id: 3, name: "Service X", price: 500 },
    { id: 3, name: "Service X", price: 500 },
    { id: 3, name: "Service X", price: 500 },
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-x-2 w-full mx-auto">
                <div className="flex flex-col w-full lg:w-6/12 mx-auto justify-start items-left mt-12 lg:mt-0  border-[1.2px] p-2 lg:p-5 bg-white gap-y-2 lg:gap-y-4 rounded-md">
                  <div className="flex flex-col justify-start items-left gap-y-0 lg:gap-y-4 ">
                    <div className="flex justify-between">
                      ...
                      {sellerSelected && (
                        <button
                          ...
                          className="flex items-center cursor-pointer gap-2 px-3 py-1 rounded-lg border border-blue-600 text-blue-600 bg-blue-50 hover:bg-blue-600 hover:text-white transition font-medium"
                        >
                    ...
                    {sellerSelected && (
                      <div className="w-full max-w-md bg-white shadow-lg rounded-xl p-4 border border-gray-200 hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="mt-3 flex justify-between items-center text-sm text-gray-500 text-left">
                          GST: {seller.gstin || "N/A"}
                        </div>
                      </div>
                    )}
                  </div>
