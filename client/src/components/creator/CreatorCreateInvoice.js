              ...
              <div className="w-full mx-auto  border-[1.2px] p-2 lg:p-4 bg-white gap-y-4 rounded-md">
                ...
                <div className="flex justify-left">
                  <div
                    ...
                    className="flex items-center cursor-pointer gap-2 px-4 py-2 mb-1 rounded-lg border border-blue-600 text-blue-600 bg-blue-50 hover:bg-blue-600 hover:text-white transition text-sm"
                  >
                    {" "}
...
export default CreatorCreateInvoice;
