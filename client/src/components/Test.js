  ...
  return (
    <main className="overflow-x-hidden w-full">
      <div className="bg-gray-50 text-gray-800">
        ...
        {/* HERO */}
        <section className="w-full overflow-hidden px-4 md:px-20 grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-x-14 py-8 md:py-24 mt-20 md:mt-20">
          <div className="mb-8">
            ...
            <div className="mt-10 max-w-5xl mx-auto px-4">
              ...
              <div className="text-center md:text-left mb-12">
                ...
                <h2 className="mt-4 text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
                  Everything in{" "}
                  <span className="text-indigo-600">One View.</span>
                </h2>
                <p className="mt-4 text-gray-500 text-lg max-w-2xl leading-relaxed">
                  Ditch the messy spreadsheets. Track every invoice, payment,
                  and client interaction through a powerful, real-time dashboard
                  designed for growth.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed">
                Everything you need to streamline your creator payments, built
        ...
        <section className="px-6 py-20 bg-blue-50/30 text-center border-y border-blue-100">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto mb-16 text-lg">
              ...
              to replace messy folders and manual docs with one clean workflow.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] mb-4">
                <HelpCircle size={14} className="text-blue-600" /> Support
                Center
              </div>
